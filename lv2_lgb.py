...
def load_mf(name):
    mf = np.concatenate(
        [
            ...
            tk.utils.load(f"models/lv1_knn1/pred_{name}.pkl"),
            tk.utils.load(f"models/lv1_knn2/pred_{name}.pkl"),
            tk.utils.load(f"models/lv1_knn3/pred_{name}.pkl"),
            tk.utils.load(f"models/lv1_knn4/pred_{name}.pkl"),
